...
PYTHON_PATH="/tmp/tangible-landscape-install/$REPO_NAME/reload/reinstall_addon.py"
...
blender --background --python "$PYTHON_PATH" -- --addon_zip_path "$ZIP_PATH" --coupling_path "$WATCH_DIR" --addon_name "$REPO_NAME"
